...
public class GameLib
{
    ...
    private static boolean safe_mode;
    ...
    public static void initGraphics(final String s, final int width, final int height) {
        ...
        System.out.println(GameLib.frame.getBufferStrategy());
    }
    ...
    public static void initGraphics_SAFE_MODE(final String s, final int n, final int n2) {
        GameLib.WIDTH = n;
        GameLib.HEIGHT = n2;
        (GameLib.frame = new MyFrame(s)).setDefaultCloseOperation(3);
        GameLib.frame.setSize(GameLib.WIDTH, GameLib.HEIGHT);
        ...
        GameLib.frame.addKeyListener((KeyListener)GameLib.keyboard);
        GameLib.frame.requestFocus();
        GameLib.frame.createBufferStrategy(1);
        GameLib.safe_mode = true;
        GameLib.buffer = new BufferedImage(n, n2, 1);
        GameLib.g = GameLib.buffer.createGraphics();
        System.out.println(GameLib.frame.getBufferStrategy());
    }
    ...
    public static void display() {
        if (GameLib.safe_mode) {
            GameLib.frame.getBufferStrategy().getDrawGraphics().drawImage(GameLib.buffer, 0, 0, null);
        ...
        GameLib.g.setColor(Color.BLACK);
